...
create table regimeparam(
    ...
    idobjectif int references objectif(idobjectif),
    idcategorie1 int references categorierepas(idcategorierepas),
    idcategorie2 int references categorierepas(idcategorierepas),
    idcategorie3 int references categorierepas(idcategorierepas),
